      ...
      <div class="cart">
        <table>
          ...
          <tbody>
            ...
            <tr v-for="goods in $store.getters['cart/validList']"
                :key="goods.skuId">
              <td>
              ...
              <td>
                <div class="goods">
                  <RouterLink :to="`/product/${goods.id}`"><img :src="goods.picture"
                         alt=""></RouterLink>
                  <div>
              ...
              <td class="tc">
                ...
                <p><a @click="deleteCart(goods.skuId)"
                     class="green"
          ...
          <tbody v-if="$store.getters['cart/invalidList']">
            ...
            <tr v-for="goods in $store.getters['cart/invalidList']"
                :key="goods.skuId">
              <td>
